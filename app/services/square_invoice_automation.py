...
async def should_send_square_invoice(
    contract: Contract,
    user: User,
    db: Session
) -> bool:
...
async def auto_send_square_invoice(
    contract: Contract,
    user: User,
    db: Session
):
...
async def create_square_invoice(
    ...
    invoice_payload = {
        "invoice": {
            ...
            "primary_recipient": {
                "customer_id": client.square_customer_id if hasattr(client, 'square_customer_id') and client.square_customer_id else None,
...
async def send_invoice_ready_email(
    client: Client,
    contract: Contract,
    user: User,
    db: Session
