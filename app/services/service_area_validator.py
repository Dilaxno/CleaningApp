...
class ServiceAreaValidator:
    ...
    def validate_zipcode_for_business(
        self, zipcode: str, business_uid: str
    ...
    def _get_zipcode_location(self, zipcode: str) -> Optional[dict[str, str]]:
        ...
        try:
            ...
            if not state or not county or not city:
                logger.debug(
                    f"ZIP code {zipcode} missing required location data: state={state}, county={county}, city={city}"
                )
                return None
    ...
    def _check_service_areas(self, zip_location: dict[str, str], service_areas: list[Dict]) -> bool:
        ...
        for area in service_areas:
            ...
            if area_type == "state":
                ...
                if zip_state == area_state and zip_county == area_county and zip_city == area_value:
                    return True
...
def validate_zipcode_for_business(
    db: Session, zipcode: str, business_uid: str
) -> tuple[bool, Optional[str]]:
