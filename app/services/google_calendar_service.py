...
async def get_valid_access_token(
    integration: GoogleCalendarIntegration, db: Session
) -> Optional[str]:
    """
...
async def create_calendar_event(user: User, schedule: Schedule, db: Session) -> Optional[str]:
    """
    ...
    try:
        ...
        integration = (
            ...
            .filter(GoogleCalendarIntegration.user_id == user.id)
            .first()
        )
...
async def update_calendar_event(
    user: User, schedule: Schedule, google_event_id: str, db: Session
) -> bool:
    """
...
async def delete_calendar_event(user: User, google_event_id: str, db: Session) -> bool:
    """
