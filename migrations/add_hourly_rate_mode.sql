-- Add hourly_rate_mode field to business_configs table
...
COMMENT ON COLUMN business_configs.hourly_rate_mode IS 'Hourly pricing mode: per_cleaner (rate × cleaners × hours) or general (rate × hours only)';
